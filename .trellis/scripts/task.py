...
Usage:
    ...
    python task.py mark-goal <dir>             # Mark task as a Trellis goal
    python task.py goal-info <dir>             # Show Trellis goal metadata
...
Examples:
  ...
  python task.py mark-goal <dir> --source new-request --cadence checkpoint-bounded
  python task.py goal-info <dir>
