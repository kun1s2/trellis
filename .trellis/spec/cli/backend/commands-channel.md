...
metadataFromCreateEvent(ev?): ChannelMetadata
  ...
  // psymoth-core/channel and do not call from CLI renderers.
...
**Worker lifecycle / inbox / delivery contracts** (owned by `psymoth-core`):
...
- Trigger: `psymoth-core` mutation APIs need replay safety for
