...
```bash
python ./.trellis/scripts/task.py mark-goal <task> --source new-request --cadence checkpoint-bounded
```
...
```bash
python ./.trellis/scripts/task.py mark-goal <task> --source planning-task --cadence checkpoint-bounded
```
...
```bash
python ./.trellis/scripts/task.py mark-goal <task> --source in-progress-task --cadence checkpoint-bounded
```
...
```bash
python ./.trellis/scripts/task.py goal-info <task>
```
