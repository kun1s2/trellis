...
description: "Bootstrap project-specific Trellis coding specs with a platform-neutral single-agent workflow. Use when creating or refreshing .trellis/spec guidelines, analyzing a codebase with code-context-search, language tooling, or source inspection, decomposing package/layer spec work, and writing real codebase-backed spec docs without placeholder text."
---
...
2. Analyze the repository architecture with `code-context-search` first when the relevant files are unclear, then language tooling and direct source reads.
...
| Code context search workflow | [references/code-context-search.md](references/code-context-search.md) |
