...
- GitNexus and ABCoder are not available in this project. Do not require or
  ...
  checks.
- Prefer the project-provided `code-context-search` / Fast Context workflow
  for semantic code location when the host exposes it. Treat results as
  candidates, then verify by reading real source files directly.
