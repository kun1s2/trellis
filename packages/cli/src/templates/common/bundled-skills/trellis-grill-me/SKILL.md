...
1. Identify the active task. Run `python3 ./.trellis/scripts/task.py current --source` if needed, then read `prd.md`, `design.md` if present, and `implement.md` if present.
